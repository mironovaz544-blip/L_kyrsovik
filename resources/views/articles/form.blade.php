...
<div class="space-y-4">
    ...
    <div>
        ...
        <select id="type" name="type" required
            ...
            @foreach(\App\Enums\ArticleTypeEnum::cases() as $type)
    ...
    @if(isset($article) && $article->mainPhoto)
        <div>
            ...
            <div class="relative inline-block">
                <img src="{{ $article->mainPhoto->thumbnail_url }}" alt="Photo" class="w-48 h-32 object-cover rounded">
                <div class="mt-2">
    ...
    <div class="flex gap-2">
        <button type="submit" class="bg-pink-600 hover:bg-pink-700 text-white font-medium py-2 px-4 rounded">
            {{ isset($article) ? 'Обновить' : 'Создать' }}
        </button>
